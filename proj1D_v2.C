...
void proj1D_v2(const char* input_d0= "/home/lz55/FlowCorr/proj1D/foutlist/HighMultiplicity/MultiplicityMT100LT250_absRapidityMT0LT2_Pt1.5_3.0_5.0_7.0_10.0/list.total_HM_new.root ", const char* input_ref = "/home/lz55/Code_v2_check/corr2D_trg_ref_PPHM80-inf_d0ana_ntrk.root ")
{
   ...
   for(int imass=0; imass<ana::nMass; imass++){
      for(int ipt=0; ipt<ana::nPt; ipt++){
         ...
         h2DSignal_D0_Small[imass][ipt]->Scale(1./nMult_D0); 

         h1DSignal_D0_Neg[imass][ipt] = h2DSignal_D0_Small[imass][ipt]->ProjectionY(
               Form("h1DSignal_D0_Neg_mass%d_pt%d", imass, ipt), etaBin[0],etaBin[1]-1);
         ...
         h1DBackground_D0_Neg[imass][ipt] = h2DBackground_D0_Small[imass][ipt]->ProjectionY(
               Form("h1DBackground_D0_Neg_mass%d_pt%d", imass, ipt), etaBin[0],etaBin[1]-1);
         ...
         int center = h2DBackground_D0_Small[imass][ipt]->FindBin(0., 0);
         //cout << "center" << "=" << center<< endl; 
         h1DSignal_D0_Neg[imass][ipt]->Divide(h1DBackground_D0_Neg[imass][ipt]); 
         h1DSignal_D0_Neg[imass][ipt]->Scale(h2DBackground_D0_Small[ipt][imass]->GetBinContent(center)); 
     }  
   }
   
   TH2D* h2DSignal_D0_Ref;
   TH2D* h2DBackground_D0_Ref; 
   TH1D* hMult_Ref; 
   ...
   cout << "test1++++++++++++++++"<< endl; 
   h2DSignal_D0_Ref = (TH2D*) f2->Get("hSignal_Ref_trk1");
   h2DBackground_D0_Ref = (TH2D*) f2->Get("hBackground_Ref_trk1" );
   hMult_Ref = (TH1D*) f2->Get("hMult_trk1");
   int nMult_Ref = hMult_Ref->Integral(2,256); 
   ...
   h1DSignal_D0_Neg_Ref->Scale(Content_Background_Deta0_Dphi0_Ref); 
   cout << "test2++++++++++++" << endl; 
   ...
   for(int imass=0; imass<ana::nMass; imass++){
      for(int ipt=0; ipt<ana::nPt; ipt++){
         ...
         h1DSignal_D0_Neg[imass][ipt]->Fit(&func, "q");
         h1DSignal_D0_Neg[imass][ipt]->Fit(&func, "q");
         h1DSignal_D0_Neg[imass][ipt]->Fit(&func, "m q");
         h1DSignal_D0_Neg[imass][ipt]->Fit(&func, "m q E");
        
         v2_smallDCA[imass][ipt] = func.GetParameter(2);
         v2_smallDCA_err[imass][ipt] = func.GetParError(2);
            
         sprintf(Tfname, "./out_check/pro_h1DSignal_D0_Neg_%d_%d.png",imass,ipt);
   ...
   h1DSignal_D0_Neg_Ref->Fit(&func_ref, "e q");
   h1DSignal_D0_Neg_Ref->Fit(&func_ref, "e q");
   h1DSignal_D0_Neg_Ref->Fit(&func_ref, "e");
   
   v2_smallDCA_Ref = func_ref.GetParameter(2); 
   v2_smallDCA_err_Ref = func_ref.GetParError(2); 

   sprintf(Tfname1, "./out_check/pro_h1DSignal_D0_Neg_Ref.png");
   cRef->SaveAs(Tfname1); 
   delete cRef; 
   ...
   TFile f3(Form("out_check/%s_v2.root", "D0_update"), "recreate");
